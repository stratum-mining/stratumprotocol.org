        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <svg className="w-full" viewBox="0 0 300 200">
              ...
              <text x="50" y="130" textAnchor="middle" className="text-sm">Miner</text>
              <text x="250" y="130" textAnchor="middle" className="text-sm">Pool</text>
              ...
              />
              <text x="150" y="80" textAnchor="middle" className="text-sm text-destructive">
                Vulnerable
              </text>
            </svg>
          </motion.div>
