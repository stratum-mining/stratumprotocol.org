  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
            Stay ahead of the curve with enhanced security, reduced bandwidth costs,
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="p-6">
              ...
              <p className="text-muted-foreground">
                Transparent transaction selection process simplifies regulatory compliance
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-muted/50">
        <div className="container mx-auto">
          <h2 className="text-4xl font-mono mb-8 text-center">Getting Started</h2>
