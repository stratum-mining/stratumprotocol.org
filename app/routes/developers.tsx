...
export default function DevelopersPage() {
  // Get the getting started content from its markdown
  const gettingStarted = developersData.find((post) => post.slug === "getting-started");
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            ul: ({
              ...
              depth,
              ...props
            }: { ordered?: boolean; depth?: number } & React.ComponentPropsWithoutRef<"ul">) => (
              <ul
                {...props}
            ...
            ol: ({
              ...
              depth,
              ...props
            }: { ordered?: boolean; depth?: number } & React.ComponentPropsWithoutRef<"ol">) => (
              <ol
                {...props}
