...
export default function BlogPostPage() {
  ...
  useLayoutEffect(() => {
    const markdownFiles = import.meta.glob("../src/_blog/*.md", {
      query: "?raw",
      import: "default",
    });
    ...
    async function fetchMarkdown() {
      try {
        const filePath = `../src/_blog/${slug}.md`;
  ...
  if (currentMarkdown) {
    const { data, content } = matter(currentMarkdown);
      ...
      return part ? (
        <ReactMarkdown
          ...
          components={{
            ...
            p: (props) => (
              <p {...props} className="font-dm-mono leading-[1.7] mb-[18px]" />
            ),
            ul: ({
              ordered,
              depth,
            ...
            table: ({ ...props }: React.ComponentPropsWithoutRef<"table">) => {
              return (
                <table
                  {...props}
                  className="w-full border-collapse my-6 font-dm-mono text-sm overflow-x-auto block"
                />
              );
            },
            ...
            th: ({
              ...
              return (
                <th
                  {...props}
                  className="px-2 sm:px-4 py-3 text-left font-semibold text-cyan-custom-100"
                />
              );
            },
            td: ({
              ...
              return (
                <td
                  {...props}
                  className="px-2 sm:px-4 py-3 whitespace-normal"
                />
              );
            },
          }}
      ...
      <div className="pt-32 md:pt-44 pb-16 px-4 container mx-auto max-w-4xl flex flex-col gap-8">
        <section className="flex flex-col gap-8">
          <button className="group w-fit">
            <Link
              to="/blog"
              className="font-dm-mono cursor-pointer font-medium flex gap-2 items-center relative"
            >
              <ArrowLeft />
              <p>Back</p>
          ...
          <h1 className="text-[2.625rem] font-dm-mono tracking-tight sm:text-5xl font-medium sm:font-semibold leading-[120%]">
            {post.title}
          </h1>
        </section>
