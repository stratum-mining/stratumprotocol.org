        ...
        <div className="container mx-auto flex flex-col gap-12 h-full">
          <div className="flex gap-10 mx-auto h-full">
            ...
            >
                  ...
                  components={{
                    ...
                    h4: ({
                      ...
                      return (
                        <h4
                          {...props}
                          className="text-2xl font-medium sm:font-medium font-dm-mono pt-7 pb-3"
                          id={sluggifyTags(props.children)}
                        />
                      );
                    },
                    ...
                    p: ({ ...props }) => (
                      <p
                        {...props}
                        className="font-dm-mono leading-[1.7] mb-[18px] whitespace-pre-wrap text-wrap break-words"
                      />
                    ),
                    ...
                    ul: ({
                      ...
                      <ul
                        {...props}
                        className="list-disc list-inside ml-4 font-dm-mono leading-[1.7] mb-4 sm:tracking-tight break-words"
                      />
                    ),
                    ...
                    ol: ({
                      ...
                      <ol
                        {...props}
                        className="list-decimal list-inside ml-4 font-dm-mono leading-[1.7] mb-4 sm:tracking-tight break-words"
                      />
                    ),
                    ...
                    li: ({
                      ...
                      <li
                        {...props}
                        className="font-dm-mono leading-[1.7] mb-[18px] list-outside ml-3"
                      />
                    ),
                    table: ({
                      ...props
                      ...
                      return (
                        <div className="relative w-full overflow-hidden rounded-lg bg-gray-900/80 my-4 border border-gray-700 max-w-[350px] min-[450px]:max-w-[400px] sm:max-w-full">
                          <div className="overflow-x-scroll">
                            <table
                              {...props}
                              className="w-full border-collapse my-0 font-dm-mono text-xs sm:text-sm sm:min-w-[500px]"
                            />
                          </div>
                        </div>
                      );
                    ...
                    thead: ({
                      ...
                      return (
                        <thead
                          {...props}
                          className="bg-gray-800/50 sticky top-0 z-10"
                        />
                      );
                    },
                    ...
                    th: ({
                      ...
                      return (
                        <th
                          {...props}
                          className="p-2 sm:p-4 text-left font-semibold text-cyan-custom-100 whitespace-nowrap"
                        />
                      );
                    },
                    ...
                    td: ({
                      ...
                      return (
                        <td
                          {...props}
                          className="p-2 sm:p-4 whitespace-normal break-words"
                        />
                      );
                    },
              ...
              <div className="mt-8">
                <a
                  href={`https://github.com/stratum-mining/sv2-spec/edit/main/${slug}.md`}
                  target="_blank"
                  className="text-cyan-custom-100 font-dm-mono underline underline-offset-4 cursor-pointer inline-flex items-center gap-2"
                >
                  Edit on GitHub
                  <ExternalLink className="w-4 h-4" />
                </a>
                <a
                  href="https://github.com/stratum-mining/sv2-spec/issues"
                  target="_blank"
                  className="ml-4 text-cyan-custom-100 font-dm-mono underline underline-offset-4 cursor-pointer inline-flex items-center gap-2"
                >
                  Ask a Question
                  <ExternalLink className="w-4 h-4" />
                </a>
