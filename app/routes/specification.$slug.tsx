...
export default function SpecificationPostPage() {
  ...
  useEffect(() => {
    ...
    async function fetchMarkdown() {
      try {
        const filePath = `../src/specification/${slug}`;
    ...
    <main className='min-h-screen bg-background text-foreground'>
      ...
      <section className='pt-32 pb-16 px-4'>
        <div className='container mx-auto flex flex-col gap-12'>
          <h1 className='text-4xl sm:text-6xl md:text-7xl font-dm-mono font-medium text-center'>Specification</h1>

          <div className='flex gap-10 mx-auto'>
            <SpecificationSidebar />

            <div className='w-fit max-w-4xl'>
              <div className='border border-cyan-custom-100 rounded-[8px] shadow-lg p-3 px-4 w-fit sticky top-20 bg-background block lg:hidden z-50'>
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  h3: ({ ...props }: React.ComponentPropsWithoutRef<"h3">) => {
                    return <h3 {...props} className='text-xl sm:text-3xl font-medium sm:font-medium font-dm-mono pt-7 pb-3' />;
                  },
