...
export default function MinersPage() {
  return (
    <main className="min-h-screen bg-background text-foreground" role="main">
      ...
      {/* Benefits Section */}
      <section
        className="py-24 px-4 bg-muted/5"
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 bg-black/20">
              <Shield
                className="w-12 h-12 text-cyan-500 mb-6"
                aria-hidden="true"
              />
      ...
      <section className="py-24 px-4" aria-labelledby="case-studies-heading">
        <div className="container mx-auto">
          <h2
            ...
            className="text-4xl font-mono mb-16 text-center"
          >
            Success Stories
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {casestudies.map((study, index) => (
              <Card key={index} className="p-6 bg-black/20" tabIndex={0}>
                ...
                <p className="text-2xl font-mono text-cyan-500 mb-2">
                  {study.metric}
                </p>
