...
const blogPosts = [
  {
    ...
    excerpt:
      'Explore how Stratum V2 is revolutionizing Bitcoin mining with enhanced security and efficiency.',
  ...
  },
  {
    ...
    excerpt:
      'Learn how one of the largest mining operations improved efficiency by 30% after implementing Stratum V2.',
  ...
  },
  {
    ...
    excerpt:
      'Technical analysis of security improvements in Stratum V2 compared to SV1.',
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12 text-center">
            Stay informed about Stratum V2 development, implementations, and
            success stories
          </p>
